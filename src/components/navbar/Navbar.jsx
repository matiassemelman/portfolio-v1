  ...
  return (
    <header className="flex justify-between align-middle h-[70px] sm:h-[100px] py-[10px]">
      <div className="text-center">
        <h1 className="text-orange font-bold text-2xl">Matias Semelman</h1>
      ...
      <nav>
        <ul className='p-2 uppercase hidden md:flex'>
          ...
          <li className='p-2'><a target="_blank" href="/wa.me/5491130332808"><AiOutlineWhatsApp/></a></li>
        </ul>
      </nav>
      <nav className={!nav ? 'fixed left-0 top-0 w-[50%] h-full border-r border-r-orange bg-orange ease-in-out duration-500' : 'fixed left-[-100%]'}>
